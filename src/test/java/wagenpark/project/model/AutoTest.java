...
public class AutoTest {
    ...
    public void expectComparisonToReturn0_whenDateOfIssuingLicensePlateIsSame(){
        ...
        var auto1 = new Auto("","",date, 0,"");
        var auto2 = new Auto("as","d",date, 10,"123456");

        Assert.assertEquals(0,auto1.compareTo(auto2));
    }
    ...
    public void expectComparisonToNotReturn0_whenDateOfIssuingLicensePlateIsDifferent(){
        ...
        var auto1 = new Auto("","",date1, 0,"");
        var auto2 = new Auto("as","d",date2, 10,"123456");

        Assert.assertNotEquals(0,auto1.compareTo(auto2));
    }
}
